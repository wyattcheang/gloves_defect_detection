function [img, mask] = edge_segmentation(org_ing, gray_img)
    ...
    img_titles = {'Edge Mask', 'Filled Mask', 'Morph Mask', 'Removed Small Objects', 'Dilated Mask', 'Applied Mask'};
    imgs = {edge_mask, filled_mask, morph_mask, removed_mask, eroded_mask, img};
